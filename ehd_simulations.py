...
def generate_fig2():
    ...
    # labels placed clear of the lines
    ax.text(0.0005,  0.004,
            "EHD: indifferent to variance",
            fontsize=9, color=NAVY, va='bottom')
    ax.text(0.0005, delta_kl[2] - 0.008,
    ...
    ax.set_xlabel(r"Variance gap $\sigma^2(b) - \sigma^2(a)$")
